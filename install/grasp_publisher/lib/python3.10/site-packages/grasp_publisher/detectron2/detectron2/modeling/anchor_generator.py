...
from grasp_publisher.detectron2.detectron2.layers import ShapeSpec, move_device_like
from grasp_publisher.detectron2.detectron2.structures import Boxes, RotatedBoxes
