...
def draw_point_cloud(rect_cx, rect_cy, rect_w, rect_h):
    rgb_image_path =  "/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/camera_capture/lab/ZED_image0.png"                    # 00000
    # rgb_image_path =  "/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/camera_capture/lab/ZED_image01.png"                   #####
    # rgb_image_path =  "/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/camera_capture/lab/ZED_image00.png"                   #####
    rgb_image = o3d.io.read_image(rgb_image_path)
    rgb_image = np.asarray(rgb_image)

    depth_image_path = "/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/camera_capture/lab/Depth_0.png"                      # 00000
    # depth_image_path = "/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/camera_capture/lab/Depth_01.png"                     #####
    # depth_image_path = "/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/camera_capture/lab/Depth_00.png"                     #####           
...
def get_GraspSample(rect_cx, rect_cy, rect_w, rect_h):
    ...
    grasps_trans = np.vstack(grasps_trans)
    grasps_rot = np.vstack(grasps_rot)

    return grasps_trans, grasps_rot
...
# translation, rotation = get_GraspSample(rect_cx, rect_cy, rect_w, rect_h)
