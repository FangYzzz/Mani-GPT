...
from . import point_cloud_grasp_sample
...
def ik(cx, cy, w, h):
    translation, rotation = point_cloud_grasp_sample.get_GraspSample(cx, cy, w, h)

    i = 0
    q_buf=[]
    for trans, rot in zip(translation, rotation):
        ...
        # input of IK class
        target = {'R': rotation_matrix, 't': trans}
        ik = IK()
        # print("-------------------------------------------------------------------------------------")
        # print('target:\n', target)
