...
from grasp_publisher.detectron2.detectron2.config import CfgNode as CN
...
def add_detic_config(cfg):
    ...
    _C.MODEL.ROI_BOX_HEAD.CAT_FREQ_PATH = \
        '/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/Detic/datasets/metadata/lvis_v1_train_cat_info.json'
