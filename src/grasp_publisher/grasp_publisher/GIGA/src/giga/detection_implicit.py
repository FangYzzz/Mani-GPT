...
#from giga import vis
from grasp_publisher.GIGA.src.giga.grasp import *
from grasp_publisher.GIGA.src.giga.utils.transform import Transform, Rotation
from grasp_publisher.GIGA.src.giga.networks import load_network
# from giga.utils import visual
# from giga.utils.implicit import as_mesh

LOW_TH = 0.5

class gigaImplicit(object):
    ...
    def __call__(self, state, return_quals=False, scene_mesh=None, aff_kwargs={}):
